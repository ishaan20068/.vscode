/*Assume that the value of a = 1, b = 2,... , z = 26. you are given a numeric string,
print all possible codes it can represent, for example 11 can be aa or k ,so print aa and k*/
#include<bits/stdc++.h>
